...
from src.Pretreatment.ConfigLoader import ConfigLoader # type: ignore
...
class DataCollector:
    ...
    def _predict_historical_data(self):
        ...
        with self.connection.cursor() as cur:
            ...
            first_record_time = first_record_time.replace(tzinfo=timezone.utc)
    ...
    def _retrain_model(self):
        ...
        end_time = datetime.now(timezone.utc)- timedelta(days=365/4)
        ...
        runner = Run(ml_pipeline, plot = False)
        runner.build_pipeline_API(data)
